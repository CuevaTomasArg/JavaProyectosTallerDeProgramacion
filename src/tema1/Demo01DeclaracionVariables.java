...
//     char sexoInicial = 'C';               /* Aqui la variable sexo queda sin inicialización */
//     double miSueldo=1000.30;
//     String miNombre="Pepe";
//     System.out.println(sexoInicial);             /* Si se descomenta no compila, no se puede imprimir porque no esta inicializada */
// }
// }
